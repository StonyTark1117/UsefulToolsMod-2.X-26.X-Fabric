...
public class ModConfiguredFeatures {
    ...
    public static void bootstrap(BootstrapContext<ConfiguredFeature<?, ?>> context) {
        ...
        List<OreConfiguration.TargetBlockState> overworldAlexandriteOres = List.of(
                OreConfiguration.target(stoneReplaceables, ModBlocks.RGOLDORE.defaultBlockState()),
                OreConfiguration.target(deepslateReplaceables, ModBlocks.RGOLD_DEEPSLATE_ORE.defaultBlockState()));
        ...
        register(context, NETHER_RGOLD_ORE_KEY, Feature.ORE, new OreConfiguration(netherrackReplaceables,
                ModBlocks.RGOLD_NETHER_ORE.defaultBlockState(), 9));
        register(context, END_RGOLD_ORE_KEY, Feature.ORE, new OreConfiguration(endReplaceables,
                ModBlocks.RGOLD_END_ORE.defaultBlockState(), 9));
